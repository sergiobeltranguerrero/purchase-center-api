package org.pfragatina.shared.infrastructure.bus.query;
...
import org.pfragatina.shared.domain.bus.query.QueryNotRegisteredError;
...
public final class QueryHandlersInformation {
    ...
    public QueryHandlersInformation() {
        Reflections                        reflections = new Reflections("org.pfragatina");
