package org.pfragatina.shared.infrastructure.bus.event;

import org.pfragatina.shared.domain.Utils;
...
public final class DomainEventSubscriberInformation {
    ...
    public String formatRabbitMqQueueName() {
        return String.format("pfragatina.%s.%s.%s", contextName(), moduleName(), Utils.toSnake(className()));
    }
}
